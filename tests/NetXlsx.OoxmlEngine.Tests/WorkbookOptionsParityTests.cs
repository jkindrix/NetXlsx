...
public class WorkbookOptionsParityTests
{
    ...
    public void ReadMaxSheets_Allows_Open_When_File_Sheet_Count_Is_Within_Limit()
    {
        ...
        try
        {
            using var wb = Workbook.OpenOoxml(path, new WorkbookOptions { ReadMaxSheets = 10 });
    ...
    public void ReadMaxSheets_Throws_ResourceLimitExceededException_When_Exceeded()
    {
        ...
        try
        {
            Action open = () => Workbook.OpenOoxml(path, new WorkbookOptions { ReadMaxSheets = 3 });
    ...
    public void ReadMaxUncompressedBytes_Allows_Open_When_Total_Is_Within_Limit()
    {
        ...
        try
        {
            using var wb = Workbook.OpenOoxml(path, new WorkbookOptions
            {
    ...
    public void ReadMaxUncompressedBytes_Throws_When_Package_Parts_Exceed_Limit()
    {
        ...
        try
        {
            Action open = () => Workbook.OpenOoxml(path, new WorkbookOptions
            {
    ...
    {
        using var wb = Workbook.CreateOoxml(new WorkbookOptions { MaxRowsPerSheet = 5 });
        var sheet = wb.AddSheet("S");
    ...
    {
        using var wb = Workbook.CreateOoxml(new WorkbookOptions { MaxColsPerSheet = 3 });
        var sheet = wb.AddSheet("S");
    ...
    public void Configured_Caps_Apply_To_Range_Coordinates()
    {
        ...
        using var wb = Workbook.CreateOoxml(new WorkbookOptions { MaxRowsPerSheet = 5, MaxColsPerSheet = 3 });
        var sheet = wb.AddSheet("S");
